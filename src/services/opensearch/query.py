...
class QueryBuilder:
    """
    A class to build OpenSearch queries for searching research papers and their chunks.
    """
    ...
    def _build_query(self) -> Dict[str, Any]:
        """Build the main query structure with must and filter clauses."""
    ...
    def _build_text_query(self) -> Dict[str, Any]:
        """Build the text search query using multi_match."""
    ...
    def _build_source_fields(self) -> Any:
        """Build the _source field configuration."""
    ...
    def _build_highlight(self) -> Dict[str, Any]:
        """Build the highlighting configuration for the query."""
    ...
    def _build_sort(self) -> Optional[List[Dict[str, Any]]]:
        """Build the sort configuration for the query."""
